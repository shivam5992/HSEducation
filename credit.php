...
<br>
<div id="entry" style="display:none;height:500;width:500;margin-top:40;margin-left:20;">
	<form action="final.php" method="post">
		<table width="407" height="158">
			<tr>
				<td width="193">CCN no(last 3 digit)</td>
				<td width="202"><input type="text" name="cno" id="cno" size="30"required="required"></td>
			</tr>
            
			<tr>
				<td>Secure Code</td>
				<td><input type="password" name="cpas" id="cpas" size="30" required="required"></td>
			</tr>
            
			<tr>
				<td>Valid upto</td>
				<td><input type="date" name="cdate" id="cdate" size="30" required="required"></td>
			</tr>
            </table>
