...
<div class="papers1">
<div class="ret">
    Previos Year Papers </div>
	<?php
include("dbconnection.php");
for($i=5;$i<=8;$i++)
{
$myquery="select * from downloads where d_id='$i'";
$result=mysql_query($myquery);
$row=mysql_fetch_row($result) ;
?>	
<div class="java">
 <a href=papers/<?php echo $row[3]; ?> ><img src=papers/<?php echo $row[4] ;?> width="81" height="110"></a><b><?php echo $row[3] ;?></b><br>T1 2010
  </div>	
<?php
}
?><br><br><br><br><br><br><br><br><div align=center style="color:black">
<a href=papers.php>View more</a></div>
</div>
